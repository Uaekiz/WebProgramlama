...
namespace webApplication.Controllers
{
    public class ReservationController : Controller
    {
        ...
        [HttpPost]
        public IActionResult Create(int seatId, string selectedDate, string startTime, string endTime, string userName)
        {
            ...
            // Model nesnesini baştan oluştur (hata durumunda ekrana geri göndereceğiz)
            var reservation = new Reservation
            {
                SeatId = seatId,
                StartTime = start,
                ...
                reservation.EndTime.Date < minDate || reservation.EndTime.Date > maxDate)
            {
                ...
                return View(reservation);   // ✅ Model ile dön
            }
            ...
            // ÇAKIŞMA KONTROLÜ (aynı gün + aynı koltuk + zaman aralığı)
    ...
    $"Rezervasyonunuz başarıyla oluşturuldu! Seçilen zaman aralığı: {reservation.StartTime:HH:mm} - {reservation.EndTime:HH:mm}, Tarih: {reservation.StartTime:dd.MM.yyyy}.";
